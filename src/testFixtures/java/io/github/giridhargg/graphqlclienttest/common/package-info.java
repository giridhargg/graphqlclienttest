 ...
 *
 * <p>Currently holds only {@link
 * io.github.giridhargg.graphqlclienttest.common.MockGraphQlServerResetExtension}, which resets
 * every {@code MockGraphQlServer} bean's queued expectations before each test method — registered
 * automatically by both {@link
 ...
 * so consumers do not need {@code @DirtiesContext} or manual reset calls to avoid expectation bleed
