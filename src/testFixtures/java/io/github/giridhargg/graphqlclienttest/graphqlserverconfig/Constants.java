...
public class Constants {
    ...
    /** Bean name for the {@link org.springframework.graphql.execution.RuntimeWiringConfigurer} registered with Spring GraphQL. */
    ...
    /** Bean name for the cached {@link io.github.giridhargg.graphqlclienttest.graphqlengine.GraphQlStaticTestAssets.Assets}. */
    public static final String GRAPHQL_STATIC_TEST_ASSETS = "graphQlStaticTestAssets";

    /** Bean name for {@link PersistedQueryTestInterceptor}. */
